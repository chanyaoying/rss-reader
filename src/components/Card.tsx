...
const Card = (
    ...
    return (
        ...
        <div className="container mx-auto px-4">
            ...
            <a href={link} target="_blank" rel="noreferrer" className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-700 dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
                ...
                <p className="font-semibold text-sm pb-2 text-gray-700 dark:text-amber-200">
                    {origin}
                </p>
